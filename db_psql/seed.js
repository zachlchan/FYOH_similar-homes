...
const seed_table = (queryString, cbString) => {
...
// seed the tables
seed_table(listings_queryString, console.timeEnd('seeding listings data'));
seed_table(similar_homes_queryString, console.timeEnd('seeding similar_homes data'));
seed_table(users_queryString, console.timeEnd('seeding users data'));
seed_table(user_favorites_queryString, console.timeEnd('seeding user_favorites data'));
